...
const Games = () => {
  ...
  const [activeGame, setActiveGame] = useState(null); // which game is open
  ...
  const games = [
    {
      ...
      title: "Flappy Bird",
      description:
        "Soar through obstacles with calm and focus. Stay present, control your rhythm, and find peace in the flow of flight.",
      gradient: "from-emerald-500 to-teal-600",
      icon: "🐦",
      iframe: "./assets/flappy%20bird/index.html",
    },
    {
      id: 2,
      title: "Tic Tac Toe",
      ...
      {activeGame && (
        <div className="fixed inset-0 bg-black z-50 flex flex-col">
          ...
          <div className="flex-1 w-full h-full">
            <iframe
              src={games.find((g) => g.id === activeGame)?.iframe}
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl sm:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
                Discover engaging, scientifically-designed games that help you
                relax, focus, and nurture your mental health journey.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Each game is carefully crafted to support different aspects of
              mental wellness
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {games.map((game, index) => (
              ...
              >
                {/* Card glow effect */}
                <div
                  className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${game.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}
                ></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6">
              ...
              <p className="text-gray-400">
                Built on proven psychological principles and mindfulness
                techniques
              </p>
            </div>
            <div className="p-6">
              ...
              <p className="text-gray-400">
                Play anywhere, anytime on any device with seamless
                synchronization
              </p>
            </div>
            <div className="p-6">
